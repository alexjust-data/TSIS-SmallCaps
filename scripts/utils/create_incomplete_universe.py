#!/usr/bin/env python3
"""
Create filtered universe parquet with only incomplete tickers.
"""
import polars as pl
...
def main():
    # Paths
    incomplete_csv = Path('01_daily/01_agregation_OHLCV/files_csv/verification_2019_2025_incomplete.csv')
    original_universe = Path('processed/universe/ping_range_2019_2025.parquet')
    output_parquet = Path('processed/universe/ping_range_2019_2025_incomplete.parquet')

    print("=" * 70)
    print("CREANDO UNIVERSE FILTRADO PARA REDOWNLOAD")
    print("=" * 70)
